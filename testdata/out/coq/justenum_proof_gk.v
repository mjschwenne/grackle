...
From New.code Require Import github_com.mjschwenne.grackle.testdata.out.go.justenum_gk.
From New.generatedproof Require Import github_com.mjschwenne.grackle.testdata.out.go.justenum_gk.
...
#[global] Instance : IsPkgInit justenum_gk := define_is_pkg_init True%I.
...
Definition own (args__v: justenum_gk.S.t) (args__c: C) (dq: dfrac) : iProp Σ :=
  "Hown_err" ∷ error_gk.own args__v.(justenum_gk.S.Err') args__c.(err') dq.

Lemma wp_Encode (args__t : justenum_gk.S.t) (args__c : C) (pre_sl : slice.t) (prefix : list u8) (dq : dfrac):
  {{{
        is_pkg_init justenum_gk ∗
        own args__t args__c dq ∗ 
        own_slice pre_sl (DfracOwn 1) prefix ∗
        own_slice_cap w8 pre_sl (DfracOwn 1)
  }}}
    @! justenum_gk.Marshal #pre_sl #args__t
  {{{
