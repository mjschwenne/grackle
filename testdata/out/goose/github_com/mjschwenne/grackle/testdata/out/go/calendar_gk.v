...
Module S. Definition id : go_string := "github.com/mjschwenne/grackle/testdata/out/go/calendar_gk.S"%go. End S.
...
#[global] Instance info' : PkgInfo calendar_gk.calendar_gk :=
  {|
    ...
    pkg_msets := msets';
    pkg_imported_pkgs := [code.github_com.goose_lang.std.std; code.github_com.tchajed.marshal.marshal; code.github_com.mjschwenne.grackle.testdata.out.go.event_gk.event_gk];
  |}.
